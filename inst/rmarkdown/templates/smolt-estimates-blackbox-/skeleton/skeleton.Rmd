...
rdata <- read_rdata(params$river, params$year, params$species)
summary_data <- read_model_result(params$river, params$year, params$species)
CU_coda <- read_CU(params$river, params$year, params$species)
...
## Summary of BlackBox results: `r  params$species` in `r params$river`  year `r params$year`

Fishing started `r rdata$startd` and stopped `r rdata$stopd`. In total 
`r sum(rdata$c, na.rm = TRUE)` `r params$species` were caught, `r sum(rdata$m, na.rm = TRUE)`
were marked and
