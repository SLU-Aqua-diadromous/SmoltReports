...
```{r per_day_plot, echo=FALSE, fig.cap="The two top plots show measured water temperature and water level. The bottom plots show the estimated trap catchabillity and the estimated number of fish passing the trap each day."}
